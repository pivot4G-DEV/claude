...
> Vendored from [leonxlnx/taste-skill](https://github.com/leonxlnx/taste-skill) (MIT license) — this is the flagship `taste-skill` from that repo (which also ships several narrower style-preset skills like `brutalist-skill`/`minimalist-skill`/`soft-skill` not installed here). See `LICENSE` in this directory for the original license terms.
