...
> Vendored from [freshtechbro/claudedesignskills](https://github.com/freshtechbro/claudedesignskills) (MIT license). See `LICENSE` in this directory for the original license terms.
