...
> Vendored from [emilkowalski/skills](https://github.com/emilkowalski/skills) (MIT license) — installed as `apple-fluid-interfaces` because this project already has an unrelated `apple-design` skill (HIG/Liquid Glass visuals). This one is about WWDC-style gesture/spring motion physics. See `LICENSE` in this directory for the original license terms.
